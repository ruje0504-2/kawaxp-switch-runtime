...
/opt/devkitpro/tools/bin/nacptool --create 'kawa' 'elf' '0.3.0' build-switch/kawaxp.nacp
/opt/devkitpro/tools/bin/elf2nro build-switch/kawaxp kawaxp.nro --nacp=build-switch/kawaxp.nacp --icon=assets/kawaxp-icon.jpg
