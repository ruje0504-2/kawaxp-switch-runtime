...
unsigned unicode_to_sjis(unsigned u);
...
#endif // NULIB_UTFSJIS
extern string gbk_cstring_to_utf8(const char *src, size_t len);
extern string gbk_to_utf8(string src);
extern char *gbk_char2unicode(const char *src, int *dst);
#define GBK_2BYTE(b) ((b) >= 0x81)
